# Проект Pythia Parser California
...
После установки всех зависимостей и настройки переменных окружения, запускаем скрипт `Pythia_parser_CA.py`:

```bash
python Pythia_parser_CA.py
```
